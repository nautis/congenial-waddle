 ...
 * Description: Import and aggregate content from RSS, Atom, and WordPress REST API feeds with keyword filtering and category management.
 * Version: 1.1.0
 * Author: Your Name
...
// Plugin version
define( 'WP_RSS_IMPORTER_VERSION', '1.1.0' );
